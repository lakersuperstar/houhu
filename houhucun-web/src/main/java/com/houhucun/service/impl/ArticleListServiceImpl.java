...
public class ArticleListServiceImpl implements ArticleListService {
	...
	public boolean updateArticleList(ArticleList articleList) {
		return articleListMapper.updateByPrimaryKey(articleList) == 1 ? true : false;
	}
	...
	@Override
	public List<ArticleListMobile> getArticleListForMobile(ArticleListQueryForMobile queryVO) {
		return articleListMapper.selectByParamForMobile(queryVO);
	}
}
