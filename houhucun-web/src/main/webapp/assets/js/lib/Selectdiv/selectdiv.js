...
//
jQuery.divselect = function(divselectid,inputselectid,type,btn,obj3,fn) {
	...
	$(divselectid+" ul li a").click(function(){
		if(type == 1){//type等于1 是单选   等于2 是多选
			...
			if($(this).find("i").attr("class") == "ico_checkbox_on"){
				$(this).parent().parent().parent().find("i").removeClass("ico_checkbox_off");
				$(this).find("i").removeClass("ico_checkbox_off").addClass("ico_checkbox_off");
			}else{
				$(this).parent().parent().parent().find("i").removeClass("ico_checkbox_on");
			}
		}else{
			if(type == 2 && $(this).find("i").attr("class") == "ico_checkbox_on" )
			{
				...
				$(this).find("i").removeClass("ico_checkbox_off").addClass("ico_checkbox_on");
				return false;
			}
		}
